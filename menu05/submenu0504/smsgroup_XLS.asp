...
<%
	...
	Call Response.AddHeader("Content-Disposition", "attachment; filename=그룹별전송내역_" &Date()& ".xls")	'바로저장하기
...
<%
	...
	if QueryYN = "Y" then	
		...
		SQL = SQL & "	GROUP BY 	CONVERT(CHAR(10),SM_Sdate,121), 	SM_CODE2 ) A GROUP BY SDATE, SGROUP ORDER BY SDATE, SGROUP"
