...
<%
	...
	If JobGb = "I" Then
		...
		SQL = "INSERT INTO TB_SMSADDR ( group_idx, name, class, sosok_name, cellphone, INCODE, INDATE, MOCODE, MODATE )"
		SQL = SQL & " VALUES ( " & group_idx & ",'"  & sname & "','"  & sclass & "','"  & sosok_name & "','"  & cellphone & "','"  & INCODE & "',getdate(),null,null)"
...
<table border="0" width="490" cellpadding="0" cellspacing="0" align="center">
	<tr height="25"><td colspan="2" class="FBlk"> ◈ <b>SMS주소록</b></td></tr>
