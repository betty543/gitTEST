...
Do while not Result1.EOF
	...
	Array1(array_cnt,6) = Result1("nameoffact")
...
<tr height="25" bgcolor="#FFFFFF">
	...
	%>
<td align="center" rowspan="<%=CInt(Array1(i,1))+CInt(Array1(i,10))%>"><b><%=Array1(i,0)%><br>(총<%=Array1(i,1)%>건)</b></td>
	<%end if%>
	<%
...
<td align="center" rowspan="<%=Array1(i,3)%>"><b><%=Array1(i,5)%></b></td>
	<%
	else
		temp_manjok = cdbl(temp_manjok) + cdbl(Array1(i,8))
	end if
	%>
<td align="center"><b><%=Array1(i,6)%></b></td>
<td align="center"><b><%=Array1(i,7)%></b></td>
<td align="center"><%=Array1(i,8)%></td>
	...
	%>
<tr bgcolor="#FFFFFF">
<td colspan=5 align="right">총<%=temp_total%>건 / <%=temp_manjok_str%></td>
</tr>
	<%end if%>
<%Next%>
