...
<%if TotalCount1 > 0 then%>
		<tr bgcolor="#FFFFFF">
			...
			<td align="center"><%=b_sum(1)+b_sum(2)+b_sum(3)%></td>
			<%
		...
		if inStr(per_sect,".") > 0 then
			...
			%>
			<td align="center"><%=b_sum(1)%><br>[<%=per_sect%>%]</td>
			<%
		...
		if inStr(per_sect,".") > 0 then
			...
			%>			
			<td align="center"><%=b_sum(2)%><br>[<%=per_sect%>%]</td>
			<%
		...
		if inStr(per_sect,".") > 0 then
			...
			%>			
			<td align="center"><%=b_sum(3)%><br>[<%=per_sect%>%]</td>
		</tr>	
<%
per_sect = 0
...
if Table_Array_from(j-1,10) <> Table_Array_from(j,10) then%>		
		<tr bgcolor="#FFFFFF">
			...
			<td align="center"><%=s_sum(1)+s_sum(2)+s_sum(3)%></td>
			<%
		...
		if inStr(per_sect,".") > 0 then
			...
			%>				
			<td align="center"><%=s_sum(1)%><br>[<%=per_sect%>%]</td>
			<%
		...
		if inStr(per_sect,".") > 0 then
			...
			%>					
			<td align="center"><%=s_sum(2)%><br>[<%=per_sect%>%]</td>
			<%
		...
		if inStr(per_sect,".") > 0 then
			...
			%>					
			<td align="center"><%=s_sum(3)%><br>[<%=per_sect%>%]</td>
		</tr>
<%
s_sum(1) = 0
s_sum(2) = 0
...
<%if Table_Array_from(j-1,9) <> Table_Array_from(j,9) then%>		
		<tr bgcolor="#FFFFFF">
			<td align="center" colspan="2">소계</td>
			<td align="center"><%=m_sum(1)+m_sum(2)+m_sum(3)%></td>
			<%
		...
		if inStr(per_sect,".") > 0 then
			...
			%>					
			<td align="center"><%=m_sum(1)%><br>[<%=per_sect%>%]</td>
			<%
		...
		if inStr(per_sect,".") > 0 then
			...
			%>					
			<td align="center"><%=m_sum(2)%><br>[<%=per_sect%>%]</td>
			<%
		...
		if inStr(per_sect,".") > 0 then
			...
			%>					
			<td align="center"><%=m_sum(3)%><br>[<%=per_sect%>%]</td>
		</tr>
<%
m_sum(1) = 0
m_sum(2) = 0
...
%>	
		...
		if inStr(per_sect,".") > 0 then
			...
			%>				
			<td align="center"><%=Table_Array_from(j,4)%><br>[<%=per_sect%>%]</td>
			<%
		...
		if inStr(per_sect,".") > 0 then
			...
			%>				
			<td align="center"><%=Table_Array_from(j,5)%><br>[<%=per_sect%>%]</td>
			<%
		...
		if inStr(per_sect,".") > 0 then
			...
			%>				
			<td align="center"><%=Table_Array_from(j,6)%><br>[<%=per_sect%>%]</td>
		</tr>	
