...
'On Error Resume next
	...
	if FromDate = "" then		
		...
		sql_where = sql_where & " and receiptfactnum like '________9___'"
		if whereCD4 <> "" then
...
%>
	...
	<tr id="cTR1" style="cursor:hand;" bgcolor="#ffffff" onmouseover="this.style.background='#FFFCE7'" bgcolor="#FFFFFF" onmouseout="this.style.background='#FFFFFF'">
			...
			<td align="center" class="TDCont" nowrap title="<%=contents%>"><a href="javascript:fn_add('<%=receiptfactnum%>');"><%=RsGBN("receiptfactnum")%></a></td>
			<td align="left" class="TDCont" title="<%=RsGBN("nameoffact")%>" nowrap>&nbsp;<a href="javascript:fn_add('<%=receiptfactnum%>');"><%=CutString(RsGBN("nameoffact"), 10, "...")%></a></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="940" align="center">
	...
	<tr height="22" bgcolor="#EEF6FF"><td align="center"><%=pageHtml%></td><td align='right'><img src="/Images/Btn/BtnADD.gif" style="cursor:hand;" align="absmiddle" onClick="fn_add('');"></td></tr>
	<tr><td height="1" bgcolor="#D6D6D6" colspan='2'></td></tr>
</table>
...
<script>
	...
	function fn_add(arg0) {
		ShowPOPLayer('monitor.asp?factnum='+arg0,'980','350');
	}
