...
%>
				...
				<tr>
					...
					<td bgcolor="#FFFFFF" align="right">
						<input type="checkbox" name="whereCD7" class="None" value="Y" onClick="fn_Search();" title="제외자료검색" <% if whereCD7 = "Y" then%>checked<%end if%>>&nbsp;
					</td>
				</tr>
			</table>
			</form>
...
%>
	...
	<tr id="cTR1" style="cursor:hand;" bgcolor="#ffffff" onmouseover="this.style.background='#FFFCE7'" bgcolor="#FFFFFF" onmouseout="this.style.background='#FFFFFF'">
			...
			<td align="left" class="TDCont" title="<%=RsGBN("nameoffact")%>" nowrap>&nbsp;<a href="javascript:fn_update('<%=receiptfactnum%>','UP');"><%=CutString(RsGBN("nameoffact"), 14, "...")%></a></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="940" align="center">
	...
	<tr height="22" bgcolor="#EEF6FF"><td align="center"><%=pageHtml%></td><td align='right'><img src="/Images/Btn/BtnTabMove1.GIF" style="cursor:hand;" align="absmiddle" onClick="fn_move();">&nbsp;<img src="/Images/Btn/BtnTabMove.GIF" style="cursor:hand;" align="absmiddle" onClick="fn_move1();">&nbsp;<% if whereCD7<>"Y" then%><img src="/Images/Btn/BtnStatis_Del.GIF" style="cursor:hand;" align="absmiddle" onClick="fn_move2();" title="통계자료에서 제외"><%else%><img src="/Images/Btn/BtnStatis_Add.GIF" style="cursor:hand;" align="absmiddle" onClick="fn_move3();"><%end if%></td></tr>
	<tr><td height="1" bgcolor="#D6D6D6" colspan='2'></td></tr>
</table>
...
<script>
	...
	function fn_Xls() {
		location.href="research03_Xls.asp?<%=where2%>"
	}
	...
	function fn_move2() {
		if ( confirm('☞ 선택한 대상으로 통계자료에서 제외시키겠습니까?'))
		{
			var i, chked=0;
			var j = 0;
			var codestring;
			...
			if ( j > 0 )
			{
				DBFrame.location= "/menu01/submenu0101/move.asp?FRM=submenu05&factnum="+codestring;
				alert('['+j+'건]이 통계자료에서 제외되었습니다. 제외건은 [완료리스트(통계자료제외)]메뉴에서 검색할 수 있습니다');
				document.inUpFrm.submit();
			}
		}
	}
