		...
		<td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor="#CCCCCC">
			    <tr>
			        ...
			        <td width="110" bgcolor="#EEF6FF" class="TDCont">사건번호 :</td>
			        <td bgcolor="#FFFFFF">
			        ...
			        <td width="80" bgcolor="#EEF6FF" class="TDCont">소속 :</td>
			        ...
			        <td width="110" bgcolor="#EEF6FF" class="TDCont">피의자명 :</td>
			        <td bgcolor="#FFFFFF">
			        	<input value="" name="FromDate" readonly type="text" size="10" onfocus="setFocusColor(this);" onClick="new CalendarFrame.Calendar(this);" onblur="setOutColor(this);"></td>

			        <td width="110" bgcolor="#EEF6FF" class="TDCont">담당수사관 :</td>
			        <td bgcolor="#FFFFFF">
