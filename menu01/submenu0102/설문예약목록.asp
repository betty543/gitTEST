	...
	<tr bgcolor="#FFFFFF">
		<td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor="#CCCCCC">
			    ...
			    <tr>
					<td bgcolor="#EFEFEF" class="TDCont">구분</td>
					<td bgcolor="#FFFFFF" colspan=3>
						<input type="radio" name="sUSEYN" value="Y" class="none" onClick="fn_YES();" checked > 금일예약목록
						<input type="radio" name="sUSEYN" value="N" class="none" onClick="fn_YES();" > 진행목록
					</td>
			    ...
			    <tr>
			        ...
			        <td width="110" bgcolor="#EFEFEF" class="TDCont">사건번호 :</td>
			        <td bgcolor="#FFFFFF">
			        ...
			        <td width="110" bgcolor="#EFEFEF" class="TDCont">피의자명 :</td>
			        <td bgcolor="#FFFFFF">
			        	<input value="" name="FromDate" readonly type="text" size="10" onfocus="setFocusColor(this);" onClick="new CalendarFrame.Calendar(this);" onblur="setOutColor(this);"></td>

			        <td width="110" bgcolor="#EFEFEF" class="TDCont">담당수사관 :</td>
			        <td bgcolor="#FFFFFF">
