...
case "UP"
	...
	IF REFERJUBSEQ <> "" THEN
		'갯수 파악하기
		SQL = "SELECT COUNT(0) FROM TB_CRIMECALLHISTORY WHERE REFERJUBSEQ ='" & REFERJUBSEQ &"' AND JUBSEQ<>'" & REFERJUBSEQ &"'"
		Set RsCNT = server.createObject("ADODB.Recordset")
		RsCNT.open SQL,db
...
'response.write SQL
	...
	if flag = "Y" then
		...
		pageUrl = "/menu03/submenu0322/lifecallmanage_Pop.asp?JUBSEQ="&JUBSEQ
...
case "DEL"
	...
	if flag = "Y" then
		...
		pageUrl = "/menu03/submenu0322/lifecallhistory_list.asp?CUSTNO="&CUSTNO
