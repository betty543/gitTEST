...
%>
		...
		<tr bgcolor="#FFFFFF">
			...
			<td align="center"><%=db_getCateNameB_("U",db_PROCESSGB_B)%><%if db_getCateNameB_("U",db_PROCESSGB_B) <> "" then %>><%end if%><%=db_getCateNameC_("U",db_PROCESSGB_B,db_PROCESSGB_C)%></td>
...
<script>
	...
	function fn_print(arg0) {	
		...
		var obj = window.open('/menu03/submenu0301/lifecallmanage_print.asp?guboon=UP&jubseq='+arg0,'lifecallmanage_print','top=0,left=0,width=760,height=600,scrollbars=yes');
		obj.focus();
	}
