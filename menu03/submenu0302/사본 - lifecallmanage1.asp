	...
	<tr bgcolor="#FFFFFF">
		<td>		
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor="#ffffff">
			    <tr height="30">
					<td align="left" bgcolor="#FFFFFF" class="TDCont" colspan="8">&nbsp;<img src="/Images/dot_01.gif" >&nbsp;<b><font color="#ff00ff"></font>상담내용 - <%=SS_LoginNAME%></b></td>
				</tr>
			</table>
			<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor="#CCCCCC">
			    <tr>
					<td bgcolor="#EEF6FF" class="TDCont" width=150 align="center" colspan='2'>상담일시</td>
					<td bgcolor="#FFFFFF" width=200 nowrap><input type="text" name="JUBTIME" value="<%=JUBTIME%>" maxlength="20" size="20" onfocus="setFocusColor(this);" onblur="setOutColor(this);" align="absmiddle">&nbsp;<input type="text" name="JUBDAY" value="<%=JUBDAY%>" maxlength="2" size="2" onfocus="setFocusColor(this);" onblur="setOutColor(this);" align="absmiddle" readonly>
					...
					<td bgcolor="#EEF6FF" class="TDCont" width=150 align="center" colspan='1'>긴급여부</td>
					<td bgcolor="#FFFFFF" width=200 nowrap>
					<font color="#ff0000"><b><input type="checkbox" name="EMERYN" value="Y" class="none" <% if EMERYN="Y" then Response.Write("checked") end if %>>긴급</b></font>
					</td>
				</tr>
				<tr>
					<td bgcolor="#EEF6FF" class="TDCont" width=150 align="center" colspan='2'>연락처1</td>
					...
					<td bgcolor="#EEF6FF" class="TDCont" width=150 align="center">발신번호</td>
				...
				<tr>
					...
					<td bgcolor="#FFFFFF" width=100 nowrap><input type="text" name="CounselorYN" value="<%=db_getCateNameCounselorYN_(SOSOKGB,SOSOKETCGB,SOSOKETCGB2)%>" style="border-width:0px ; border-color:#EEF6FF ; border-style:solid; text-align:left; font-color:#ff0000;font-weight:bold" readonly>
					</td>
				</tr>
			    <tr>
				...
				<tr id="divLEVEL_B" style="display:block;">
					<td bgcolor="#EEF6FF" class="TDCont" width=100 align="center" rowspan='2'>계    급</td>
					<td bgcolor="#EEF6FF" class="TDCont" align="center" width=50>1차&nbsp;</td>
...
<%
				...
				<tr id="divCALLKIND_1" style="display:block;">
					<td bgcolor="#EEF6FF" class="TDCont" width=100 align="center" rowspan='2'>원인제공자#1<br><img src="/Images/Btn/BtnAdd1.gif" style="cursor:hand;" align="absmiddle" onClick="fn_AddForm('ON','6','6');"></td>
					<td bgcolor="#EEF6FF" class="TDCont" align="center" width=50>1차</td>
					<td bgcolor="#FFFFFF" nowrap colspan='5'><iframe src="/menu03/submenu0301/frame_CLASS.asp?frame_nm=frame_callkind_B&CLASSNM=CALLKIND&CLASSGB=B&ACLASS=R&BCLASS=<%=CALLKIND_B%>" scrolling="no" frameborder="0" width=100% height=25 name="frame_callkind_B"></iframe>		
					</td>
				</tr>
				...
				<tr id="divCALLCLASS_B_6" style="display:none;">
					<td bgcolor="#FDE6F3" class="TDCont" width=100 align="center" rowspan='2'>원인제공자#2<br><img src="/Images/Btn/BtnDel1.gif" style="cursor:hand;" align="absmiddle" onClick="fn_AddForm('OFF','6','6');"></td>
					<td bgcolor="#FDE6F3" class="TDCont" align="center" width=50>1차</td>
					<td bgcolor="#FFFFFF" nowrap colspan='5'><iframe src="/menu03/submenu0301/frame_CLASS.asp?frame_nm=frame_callkind_B_2&CLASSNM=CALLKIND_2&CLASSGB=B&ACLASS=R&BCLASS=<%=CALLKIND_B_2%>" scrolling="no" frameborder="0" width=100% height=25 name="frame_callkind_B_2"></iframe>		
					</td>
				</tr>
...
<table width="1200" height="5" border="0" cellspacing="0" cellpadding="0" align="center"><tr><td align='left'><img src="/Images/Btn/BtnList.gif" style="cursor:hand;" align="absmiddle" onClick="fn_list();"></td><td align="right"><img src="/Images/Btn/BtnASRegi.gif" style="cursor:hand;" class="None" align="absmiddle" onClick="fn_inup();"></td></tr></table>
...
*/
	...
	{
		//alert(arg0);
		if ( arg0 == 'WEATHER' || arg0 == 'PROCESSGB' || arg0 == 'REQUESTERGB' || arg0 == 'FAMILYGB' || arg0 == 'CALLFLAG')
		{
			//날씨
		...
		else if ( arg0 == 'frame_level_B' ) //계급1차
		{
			...
			frame_level_C.location.href ="/menu03/submenu0301/frame_CLASS.asp?frame_nm=frame_level_C&CLASSNM=LEVEL&CLASSGB=C&ACLASS=P&BCLASS=&CCLASS=";
		}
