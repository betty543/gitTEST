...
Call Response.AddHeader("Content-Disposition", "attachment; filename=군범죄신고통계_" &Date()& ".xls")	'바로저장하기
...
End If
If CHANNELGB5 <> "" And CHANNELGB = "" then
	CHANNELGB = "''" & CHANNELGB5 & "''"
ElseIf CHANNELGB5 <> "" then
	CHANNELGB = CHANNELGB & ",''" & CHANNELGB5 & "''"
End If
...
pageWHERE = pageWHERE & "&channelGb1=" & CHANNELGB1 & "&channelGb2=" & CAHNNELGB2 & "&channelGb3=" & CHANNELGB3 & "&channelGb4=" & CHANNELGB4 & "&channelGb5=" & CHANNELGB5
...
<table border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td>
			...
			elseif whereCD8 = "상담분야1" then'상담분야 - 2depth
				sSero = "<td align='center' class='TDCont'  width='300' colspan='2' "
				sSero1 = "상담분야</td>"
				cols = 2
				sDepth = 2
			...
			elseif whereCD8 = "조치별1" then'조치별 - 1depth
				sSero = "<td align='center' class='TDCont'  width='150' colspan='1' "
				sSero1 = "조치별</td>"
				sSelectCol = "PROCESSGB col_1"
				sGroupBy = "PROCESSGB"
				sSelectCol1 = "PROCESSGB"
				sNullCol = " AND  isnull(PROCESSGB,'''') <> '''' "
			...
			elseif whereCD8 = "원인제공자1" then'원인제공자 - 1depth
				sSero = "<td align='center' class='TDCont'  width='150' colspan='1' "
				sSero1 = "원인제공자</td>"
			...
			if whereCD9 = "상담유형" then'상담유형 - 2depth
				...
				sSQL = " EXEC SP_SUM_BY_HISTORY_BCLASS " & sDepth & ",'" & FromDate & "','" & ToDate & "','TB_CRIMECALLHISTORY','"&whereCD2 & "','"& whereCD1 & "','"&sCOLNM&"','Q','','"&sGroupBy&"','"&sSelectCol&"','"&sSelectCol1&"','"&sNullCol&"','"&CHANNELGB&"','','',''"
			...
			elseif whereCD9 = "부대1차" then'부대	  - 5depth
				...
				sSQL = " EXEC SP_SUM_BY_HISTORY_ACLASS " & sDepth & ",'" & FromDate & "','" & ToDate & "','TB_CRIMECALLHISTORY','"&whereCD2 & "','"& whereCD1 & "','"&sCOLNM&"','"&sCOLCD&"','"&sGroupBy&"','"&sSelectCol&"','"&sSelectCol1&"','"&sNullCol&"','"&CHANNELGB&"','','',''"
			...
			elseif whereCD9 = "상담분야1" then'상담분야 - 2depth
	
				rowspan = 2
				sSQL = "	select ACLASS, BCLASS, CCLASS, CLASSNAME from TB_ARMYINFO "
				sSQL = sSQL & "	where ACLASS = 'S' AND BCLASS IS NOT NULL AND CCLASS IS NULL"
				sSQL = sSQL & "	ORDER BY ACLASS, BCLASS, CCLASS "
				set RsCode = db.execute(sSQL)
				...
				Do Until rsCode.eof
					...
					sCodeList = ""
					sSQL = "	select ACLASS, BCLASS, CCLASS, CLASSNAME from TB_ARMYINFO "
					sSQL = sSQL & "	where ACLASS = 'S' AND BCLASS = '" &sCode&"'  AND CCLASS IS NOT NULL"
					sSQL = sSQL & "	ORDER BY ACLASS, BCLASS, CCLASS "
					set RsCode1 = db.execute(sSQL)
			...
			elseif whereCD9 = "조치별1" then'조치별 - 1depth
	
				rowspan = 1
				sSQL = "	select CODE, CODENAME from TB_CODE "
				sSQL = sSQL & "	where CODEGROUP = 'C21' AND USEYN = 'Y'"
				...
				sSQL = " EXEC SP_SUM_BY_CODE " & sDepth & ",'" & FromDate & "','" & ToDate & "','TB_CRIMECALLHISTORY','"&whereCD2 & "','"& whereCD1 & "','"&sCOLNM&"','"&sCOLCD&"','"&sGroupBy&"','"&sSelectCol&"','"&sSelectCol1&"','"&sNullCol&"','"&CHANNELGB&"','','',''"
			...
			elseif whereCD9 = "원인제공자1" then'원인제공자 - 1depth
				
				rowspan = 1
				sSQL = "	select ACLASS, BCLASS, CCLASS, CLASSNAME from TB_ARMYINFO "
				sSQL = sSQL & "	where ACLASS = 'T' AND BCLASS IS NOT NULL AND CCLASS IS NULL"
				sSQL = sSQL & "	ORDER BY ACLASS, BCLASS, CCLASS "
				set RsCode = db.execute(sSQL)
			...
			elseif whereCD9 = "상담관" then'상담관 - 1depth
				...
				rowspan = 1
				sSQL = "	select distinct INCODE FROM TB_CRIMECALLHISTORY"
				...
				sSQL = " EXEC SP_SUM_BY_INCODE " & sDepth & ",'" & FromDate & "','" & ToDate & "','TB_CRIMECALLHISTORY','"&whereCD2 & "','"& whereCD1 & "','"&sCOLNM&"','"&sCOLCD&"','"&sGroupBy&"','"&sSelectCol&"','"&sSelectCol1&"','"&sNullCol&"','"&CHANNELGB&"','','',''"
			...
			elseif whereCD9 = "시간" then'시간 - 1depth
				...
				sSQL = " EXEC SP_SUM_BY_HISTORY_HOUR " & sDepth & ",'" & FromDate & "','" & ToDate & "','TB_CRIMECALLHISTORY','"&whereCD2 & "','"& whereCD1 & "','"&sCOLNM&"','"&sCOLCD&"','"&sGroupBy&"','"&sSelectCol&"','"&sSelectCol1&"','"&sNullCol&"','"&CHANNELGB&"','','',''"
			...
			elseif whereCD9 = "요일" then'요일 - 1depth
				...
				sSQL = " EXEC SP_SUM_BY_HISTORY_WEEKDAY " & sDepth & ",'" & FromDate & "','" & ToDate & "','TB_CRIMECALLHISTORY','"&whereCD2 & "','"& whereCD1 & "','"&sCOLNM&"','"&sCOLCD&"','"&sGroupBy&"','"&sSelectCol&"','"&sSelectCol1&"','"&sNullCol&"','"&CHANNELGB&"','','',''"
			...
			elseif whereCD9 = "통화시간" then'통화시간 - 1depth
				...
				sSQL = " EXEC SP_SUM_BY_HISTORY_CALLTIME " & sDepth & ",'" & FromDate & "','" & ToDate & "','TB_CRIMECALLHISTORY','"&whereCD2 & "','"& whereCD1 & "','"&sCOLNM&"','"&sCOLCD&"','"&sGroupBy&"','"&sSelectCol&"','"&sSelectCol1&"','"&sNullCol&"','"&CHANNELGB&"','','',''"
