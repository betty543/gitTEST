		...
		<td>
			...
			<table width="600" border="1" cellspacing="1" cellpadding="1" align="center" bgcolor="#CCCCCC" bordercolor="black" bordercolordark="white" bordercolorlight="black">
				...
				<tr>
					...
					<td bgcolor="#FFFFFF" colspan='3'>&nbsp;<b><%=db_getCateNameB_("Q",db_CHANNELGB_B)%><%if db_getCateNameB_("Q",db_CHANNELGB_B) <> "" then %>><%end if%><%=db_getCateNameC_("Q",db_CHANNELGB_B,db_CHANNELGB_C)%>&nbsp;&nbsp;&nbsp;&nbsp;<%if EMERYN="Y" then%><font color="#ff0000"><b>긴급</b></font><%end if%>
					</td>
			    ...
			    <tr>
					...
					<td bgcolor="#FFFFFF" >&nbsp;<b><%=db_getCateNameB_("U",db_PROCESSGB_B)%><%if db_getCateNameB_("U",db_PROCESSGB_B) <> "" then %>><%end if%><%=db_getCateNameC_("U",db_PROCESSGB_B,db_PROCESSGB_C)%></b>
					</td>					
