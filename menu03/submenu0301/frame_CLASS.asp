...
function fn_SetSosok3(CLASSNM,CLASSGB,ACLASS,BCLASS,CCLASS,DCLASS,ECLASS,CLASSNAME,CounselorYN)
{
	...
	if ( CLASSNM == 'PROCESSGB' )
	{

		if ( CLASSGB == 'A' )
		{
			parent.frame_processgb_B.location = "/menu03/submenu0301/frame_CLASS.asp?frame_nm=frame_processgb_B&CLASSNM=PROCESSGB&CLASSGB=B&ACLASS="+ACLASS+"&BCLASS="+BCLASS+"&CCLASS="+CCLASS+"&DCLASS="+DCLASS+"&ECLASS="+ECLASS;
		}
		if ( CLASSGB == 'B' )
		{
			parent.document.all.PROCESSGB_B.value = BCLASS;
			parent.document.all.PROCESSGB_C.value = "";
			parent.frame_processgb_C.location = "/menu03/submenu0301/frame_CLASS.asp?frame_nm=frame_processgb_C&CLASSNM=PROCESSGB&CLASSGB=C&ACLASS="+ACLASS+"&BCLASS="+BCLASS+"&CCLASS="+CCLASS+"&DCLASS="+DCLASS+"&ECLASS="+ECLASS;
		}
		if ( CLASSGB == 'C' )
		{
			parent.document.all.PROCESSGB_C.value = CCLASS;
		}
	}
}
function fn_putetc2()
