	...
	<tr bgcolor="#FFFFFF">
		<td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor="#ffffff">
			    <tr>
					<td align="left" bgcolor="#FFFFFF" class="TDCont">◈상담일시: 2009-01-01 13:05:59(화)</td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor="#CCCCCC">
			    ...
			    <tr>
					...
					<td bgcolor="#FFFFFF" colspan=7 width=850>	<textarea name="REPLYA1" style="width:100%; height:300" wrap="soft" class="TextareaInput" onKeyUp="fn_SetTEXT('REPLYA','1',this.value); UpdateChar('inUpFrm.REPLYA1',4000,5);"></textarea>			
					</td>
				</tr>
			    <tr>
