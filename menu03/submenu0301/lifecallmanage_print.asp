...
<div id="A" style="OVERFLOW-Y: auto; MARGIN: 0px 0px 0px 0px; WIDTH: 760;  HEIGHT: 580;">
		...
		<td>
			...
			<table width="600" border="1" cellspacing="1" cellpadding="1" align="center" bgcolor="#CCCCCC" bordercolor="black" bordercolordark="white" bordercolorlight="black">
			    ...
			    <tr>
					...
					<td bgcolor="#FFFFFF" colspan='3'>&nbsp;<b><%=db_getCateNameB_("U",db_PROCESSGB_B)%><%if db_getCateNameB_("U",db_PROCESSGB_B) <> "" then %>><%end if%><%=db_getCateNameC_("U",db_PROCESSGB_B,db_PROCESSGB_C)%></b>
					</td>					
