...
<table border="0" width="940" cellpadding="0" cellspacing="3" bgcolor="#EFECE5" align="center">
	...
	<form method="post" name="inUpFrm" style="margin:0" action="/menu03/submenu0322/lifecallmanage_refersearch.asp">
	<tr bgcolor="#FFFFFF">
		<td>
...
<%
	...
	if QueryYN = "Y" then
		...
		sql = " select count(*) + 1 from tb_crimecallhistory where CUSTNO = '" & db_CUSTNO & "'"
...
<script>
	...
	function fn_Detail(arg0) {	
		...
		historyDetail.location = "/menu03/submenu0321/History_Detail.asp?JUBSEQ="+arg0+"&Keyword=";	
	}
	function fn_Search() {
