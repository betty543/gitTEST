...
// iframe 사이즈 적용
function fn_SetSosok3(CLASSNM,CLASSGB,ACLASS,BCLASS,CCLASS,DCLASS,ECLASS,CLASSNAME)
{
		...
		<%
			...
			'else
				...
				IF CLASSNM = "SOSOK" THEN
					IF CLASSGB = "A" THEN
						SqlCode = "select * from tb_armyinfo where aclass < 'O' and bclass is NULL order by bclass"
				...
				do until RsCode.eof
					...
					IF CLASSGB = "A" THEN
						...
						if j = 1 then
							sReplyHtml = "<input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&sValue&"','','','','','"&sValueName&"');"">" & sValueName	
						elseif j = 11 or j = 21  then
							sReplyHtml = sReplyHtml & "<br><input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&sValue&"','','','','','"&sValueName&"');"">" & sValueName
						else
							sReplyHtml = sReplyHtml & "&nbsp;<input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&sValue&"','','','','','"&sValueName&"');"">" & sValueName
						end if
					...
					ELSEIF CLASSGB = "B" AND CLASSNM = "SOSOK" THEN
						...
						if j = 1 then
							sReplyHtml = "<input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&ACLASS&"','"&sValue&"','','','','"&sValueName&"');"">" & sValueName	
						elseif j = 11 or j = 21  then
							sReplyHtml = sReplyHtml & "<br><input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&ACLASS&"','"&sValue&"','','','','"&sValueName&"');"">" & sValueName
						else
							sReplyHtml = sReplyHtml & "&nbsp;<input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&ACLASS&"','"&sValue&"','','','','"&sValueName&"');"">" & sValueName
						end if
					...
					ELSEIF CLASSGB = "C" THEN
						...
						if j = 1 then
							sReplyHtml = "<input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&ACLASS&"','"&BCLASS&"','"&sValue&"','','','"&sValueName&"');"">" & sValueName	
						elseif j = 13  then
							sReplyHtml = sReplyHtml & "<br><input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&ACLASS&"','"&BCLASS&"','"&sValue&"','','','"&sValueName&"');"">" & sValueName	
						else
							sReplyHtml = sReplyHtml & "&nbsp;<input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&ACLASS&"','"&BCLASS&"','"&sValue&"','','','"&sValueName&"');"">" & sValueName	
						end if
					...
					ELSEIF CLASSGB = "D" THEN
						...
						if j = 1 then
							sReplyHtml = "<input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&ACLASS&"','"&BCLASS&"','"&CCLASS&"','"&sValue&"','','"&sValueName&"');"">" & sValueName	
						elseif j = 11 or j = 21  then
							sReplyHtml = sReplyHtml & "<br><input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&ACLASS&"','"&BCLASS&"','"&CCLASS&"','"&sValue&"','','"&sValueName&"');"">" & sValueName	
						else
							sReplyHtml = sReplyHtml & "&nbsp;<input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&ACLASS&"','"&BCLASS&"','"&CCLASS&"','"&sValue&"','','"&sValueName&"');"">" & sValueName	
						end if
					...
					ELSEIF CLASSGB = "E" THEN
						...
						if j = 1 then
							sReplyHtml = "<input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&ACLASS&"','"&BCLASS&"','"&CCLASS&"','"&DCLASS&"','"&sValue&"','"&sValueName&"');"">" & sValueName	
						elseif j = 11 or j = 21  then
							sReplyHtml = sReplyHtml & "<br><input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&ACLASS&"','"&BCLASS&"','"&CCLASS&"','"&DCLASS&"',"&sValue&",'"&sValueName&"');"">" & sValueName
						else
							sReplyHtml = sReplyHtml & "&nbsp;<input type='RADIO' value='" & sValue & "' name='"&CLASSNM&CLASSGB &"' class='none' " & SelectedValue & " onClick=""fn_SetSosok3('"&CLASSNM&"','"&CLASSGB&"','"&ACLASS&"','"&BCLASS&"','"&CCLASS&"','"&DCLASS&"',"&sValue&",'"&sValueName&"');"">" & sValueName
						end if
