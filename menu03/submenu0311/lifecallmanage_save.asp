...
<%
	...
	Call Response.AddHeader("Content-Disposition", "attachment; filename=후속상담일지" &JUBSEQ& ".xls")	'바로저장하기
	...
	<tr bgcolor="#FFFFFF">
		<td>	
			...
			<table width="600" border="1" cellspacing="1" cellpadding="1" align="center" bgcolor="#CCCCCC" bordercolor="black" bordercolordark="white" bordercolorlight="black">
			    ...
			    <tr>
					<td bgcolor="#EEF6FF" class="TDCont" width=100 align="center" >원상담자</td>
					<td bgcolor="#FFFFFF" ><%=db_GetCustNameA(db_REFERJUBSEQ)%></b>
					</td>

					<td bgcolor="#EEF6FF" class="TDCont" width=100 align="center" colspan='1' nowrap>원상담자와의관계</td>
					<td bgcolor="#FFFFFF" colspan='1'>&nbsp;<b><%=db_GetCodeName("C14",db_REQUESTERGB)%></b>
					</td>
					<td bgcolor="#EEF6FF" class="TDCont" width=100 align="center" >후속확인1</td>
