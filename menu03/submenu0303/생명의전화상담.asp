	...
	<tr bgcolor="#FFFFFF">
		<td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor="#ffffff">
			    <tr>
					<td align="left" bgcolor="#FFFFFF" class="TDCont"><b>◈상담일시: 2009-01-01 13:05:59(화)</b></td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor="#CCCCCC">
			    <tr>
					...
					<td bgcolor="#FFFFFF" width=200 colspan=3>1차 - 2차 - 3차분류 <img src="/Images/Comm/IconTip.gif" style="cursor:hand;" align="absmiddle">
					</td>

				</tr>
			    <tr>
					<td bgcolor="#EEF6FF" class="TDCont" width=150>내담자이름</td>
					<td bgcolor="#FFFFFF" width=200><input type="text" name="sCTIID" value="" maxlength="20" size="20" onfocus="setFocusColor(this);" onblur="setOutColor(this);" align="absmiddle">
					</td>
					...
					<td bgcolor="#FFFFFF" width=200><input type="text" name="sCTIID" value="" maxlength="20" size="20" onfocus="setFocusColor(this);" onblur="setOutColor(this);" align="absmiddle"> <img src="/Images/Comm/IconAlert.gif" style="cursor:hand;" onClick="fn_dial('1');" align="absmiddle" title="전화걸기">
					</td>
					<td bgcolor="#EEF6FF" class="TDCont" width=150>의뢰인</td>
			    ...
			    <tr>
					...
					<td bgcolor="#FFFFFF" width=200>OOO
					</td>
...
<table border="0" width="1200" cellpadding="0" cellspacing="3" bgcolor="#EFECE5" align="center">
	<tr bgcolor="#FFFFFF">
		<td>
			<table width="100%" border="0" cellspacing="1" cellpadding="1" align="center" bgcolor="#ffffff">
			    <tr>
					<td align="left" bgcolor="#FFFFFF" class="TDCont"><b>◈상담이력</b></td>
					<td align="right"></td>
				</tr>
			</table>

	<table border="0" width="100%" cellspacing="1" cellpadding="0" width="100%" bgcolor="#CCCCCC" align="center">
