...
Call Response.AddHeader("Content-Disposition", "attachment; filename=상담현황통계_" &Date()& ".xls")	'바로저장하기
...
pageWHERE = pageWHERE & "&channelGb1=" & CHANNELGB1 & "&channelGb2=" & CAHNNELGB2 & "&channelGb3=" & CHANNELGB3 & "&channelGb4=" & CHANNELGB4
%>
	...
	<tr>
		<td>
			...
			<!--<DIV style="OVERFLOW-Y:auto; OVERFLOW-X:auto; MARGIN: 0px 0px 0px 0px; WIDTH:940; HEIGHT:500;">-->
				<table width="1250"  border="1" cellpadding="0" cellspacing="0" bgcolor="#EFECE5" align="center" bordercolor="black" bordercolordark="white" bordercolorlight="black">
					<tr bgcolor='#EEF6FF'>
						<td align='center' class='TDCont' width='250'>080생명</td>
						<td align='center' class='TDCont' width='250'>1303생명</td>
						<td align='center' class='TDCont' width='250'>1303성범죄</td>
						<td align='center' class='TDCont' width='250'>1303군범죄</td>
						<td align='center' class='TDCont' width='250'>계</td>
					</tr>
					...
					SQL = SQL & "			AND	jubdate <= '" & ToDate & "'  and CHANNELGB_B in ('Q01','Q03') " & chSql & " and CHANNELGB = '0179'" '상담,
					SQL = SQL & "		union all "
					SQL = SQL & " 		SELECT	'02' gubun, count(*) cnt FROM	TB_lifecallhistory	where jubdate >= '" & FromDate & "' "
					SQL = SQL & "			AND	jubdate <= '" & ToDate & "'  and CHANNELGB_B in ('Q01','Q03') " & chSql & " and CHANNELGB = '13031'" '상담,
					SQL = SQL & "		union all "
					SQL = SQL & " 		SELECT	'03' gubun, count(*) cnt FROM	TB_lifecallhistory	where jubdate >= '" & FromDate & "' "
					SQL = SQL & "			AND	jubdate <= '" & ToDate & "'  and CHANNELGB_B in ('Q01','Q03') " & chSql & " and CHANNELGB = '13032'" '상담,
					SQL = SQL & "		union all "
					SQL = SQL & " 		SELECT	'04' gubun, count(*) cnt FROM	TB_lifecallhistory	where jubdate >= '" & FromDate & "' "
					SQL = SQL & "			AND	jubdate <= '" & ToDate & "'  and CHANNELGB_B in ('Q01','Q03') " & chSql & " and CHANNELGB = '13033'" '상담,
					SQL = SQL & "		union all "
					...
					loop
						...
						<tr bgcolor='#EEF6FF'>
							<td bgcolor='#ffffff' align='center' class='TDCont' width="250"><%=formatnumber(tot1,0)%></td>
							<td bgcolor='#ffffff' align='center' class='TDCont' width="250"><%=tot2%></td>
							<td bgcolor='#ffffff' align='center' class='TDCont' width="250"><%=tot3%></td>
							<td bgcolor='#ffffff' align='center' class='TDCont' width="250"><%=tot4%></td>
							<td bgcolor='#ffffff' align='center' class='TDCont' width="250"><%=tot5%></td>	
			...
			<table width="1200"  border="1" cellpadding="0" cellspacing="0" bgcolor="#EFECE5" align="left" bordercolor="black" bordercolordark="white" bordercolorlight="black">
				<tr height="30">
					<td align="left" bgcolor="#FFFFFF" class="TDCont" colspan="18">&nbsp;&nbsp;<b><font color="#ff00ff"></font> 1. 상담유형</b></td>
				</tr>
				<tr bgcolor='#EEF6FF'>
			...
			<table width="100%" height="5" border="0" cellspacing="0" cellpadding="0" align="left"><tr><td></td></tr></table>
			...
			<table width="1200"  border="1" cellpadding="0" cellspacing="0" bgcolor="#EFECE5" align="left" bordercolor="black" bordercolordark="white" bordercolorlight="black">
				...
				<tr height="30">
					<td align="left" bgcolor="#FFFFFF" class="TDCont" colspan="<%=tot2+2%>">&nbsp;&nbsp;<b><font color="#ff00ff"></font> 2. 상담관별</b></td>
				</tr>
			...
			<table width="2000"  border="1" cellpadding="0" cellspacing="0" bgcolor="#EFECE5" align="left" bordercolor="black" bordercolordark="white" bordercolorlight="black">
				<tr height="30">
					<td align="left" bgcolor="#FFFFFF" class="TDCont" colspan="300">&nbsp;&nbsp;<b><font color="#ff00ff"></font> 3. 계급별</b></td>
				</tr>
				...
				subSql = subSql & "	 from tb_lifecallhistory  where jubdate >= '" & FromDate & "' AND		jubdate <= '" & ToDate & "' and CHANNELGB_B in ('Q01','Q03','Q05','Q07','Q09','Q99') "
				subSql = subSql & " 	 " & chSql & " "
			...
			<table width="2200"  border="1" cellpadding="0" cellspacing="0" bgcolor="#EFECE5" align="left" bordercolor="black" bordercolordark="white" bordercolorlight="black">
				<tr height="30">
					<td align="left" bgcolor="#FFFFFF" class="TDCont" colspan="300">&nbsp;&nbsp;<b><font color="#ff00ff"></font> 4. 부대별</b></td>
				</tr>
				...
				execSQL = execSQL & "	 from tb_lifecallhistory  where jubdate >= '" & FromDate & "' AND		jubdate <= '" & ToDate & "'  " & chSql
			...
			<table width="4500"  border="1" cellpadding="0" cellspacing="0" bgcolor="#EFECE5" align="center" bordercolor="black" bordercolordark="white" bordercolorlight="black">
				<tr height="30">
					<td align="left" bgcolor="#FFFFFF" class="TDCont" colspan="300">&nbsp;&nbsp;<b><font color="#ff00ff"></font> 5. 상담분야별</b></td>
				</tr>
			...
			<table width="1200" height="5" border="0" cellspacing="0" cellpadding="0" align="left"><tr><td></td></tr></table>
			
			<table width="1200"  border="1" cellpadding="0" cellspacing="0" bgcolor="#EFECE5" align="left" bordercolor="black" bordercolordark="white" bordercolorlight="black">
				<tr height="30">
					<td align="left" bgcolor="#FFFFFF" class="TDCont" colspan="9">&nbsp;&nbsp;<b><font color="#ff00ff"></font> 6. 요일별</b></td>
				</tr>
				<tr bgcolor='#EEF6FF'>
				...
				'상담관별 총계
				SQL = "select * from ( "
				SQL = SQL & " 	SELECT	'1' gubun, count(incode) cnt FROM	TB_lifecallhistory	where jubdate >= '" & FromDate & "'"
				SQL = SQL & "		AND		jubdate <= '" & ToDate & "' and datepart(weekday,jubdate) = 2 "&chSql
				SQL = SQL & "	union all "
				SQL = SQL & " 	SELECT	'2' gubun, count(incode) cnt FROM	TB_lifecallhistory	where jubdate >= '" & FromDate & "'"
				SQL = SQL & "		AND		jubdate <= '" & ToDate & "' and datepart(weekday,jubdate) = 3  "&chSql
				SQL = SQL & "	union all "
				SQL = SQL & " 	SELECT	'3' gubun, count(incode) cnt  FROM	TB_lifecallhistory	where jubdate >= '" & FromDate & "'"
				SQL = SQL & "		AND		jubdate <= '" & ToDate & "' and datepart(weekday,jubdate) = 4 "&chSql
				SQL = SQL & "	union all "
				SQL = SQL & " 	SELECT	'4' gubun, count(incode) cnt  FROM	TB_lifecallhistory	where jubdate >= '" & FromDate & "'"
				SQL = SQL & "		AND		jubdate <= '" & ToDate & "' and datepart(weekday,jubdate) = 5 "&chSql
				SQL = SQL & "	union all "
				SQL = SQL & " 	SELECT	'5' gubun, count(incode) cnt  FROM	TB_lifecallhistory	where jubdate >= '" & FromDate & "'"
				SQL = SQL & "		AND		jubdate <= '" & ToDate & "' and datepart(weekday,jubdate) = 6 "&chSql
				SQL = SQL & "	union all "
				SQL = SQL & " 	SELECT	'6' gubun, count(incode) cnt  FROM	TB_lifecallhistory	where jubdate >= '" & FromDate & "'"
				SQL = SQL & "		AND		jubdate <= '" & ToDate & "' and datepart(weekday,jubdate) = 7 "&chSql
				SQL = SQL & "	union all "
				SQL = SQL & " 	SELECT	'7' gubun, count(incode) cnt  FROM	TB_lifecallhistory	where jubdate >= '" & FromDate & "'"
				SQL = SQL & "		AND		jubdate <= '" & ToDate & "' and datepart(weekday,jubdate) = 1 "&chSql
				SQL = SQL & "	union all "
				SQL = SQL & " 	SELECT	'8' gubun, count(incode) cnt  FROM	TB_lifecallhistory	where jubdate >= '" & FromDate & "'"
			...
			<table width="1200"  border="1" cellpadding="0" cellspacing="0" bgcolor="#EFECE5" align="left" bordercolor="black" bordercolordark="white" bordercolorlight="black">
				<tr height="30">
					<td align="left" bgcolor="#FFFFFF" class="TDCont" colspan="26">&nbsp;&nbsp;<b><font color="#ff00ff"></font> 7. 시간대별</b></td>
				</tr>
				<tr bgcolor='#EEF6FF'>
					<td align='center' class='TDCont'  width='150'>구분</td>
			...
			<table width="1200"  border="1" cellpadding="0" cellspacing="0" bgcolor="#EFECE5" align="center" bordercolor="black" bordercolordark="white" bordercolorlight="black">
				<tr height="30">
					<td align="left" bgcolor="#FFFFFF" class="TDCont" colspan="11">&nbsp;&nbsp;<b><font color="#ff00ff"></font> 8. 통화시간별</b> (사이버,전화끊김,침묵(탐색)전화,기타 제외)</td>
				</tr>
				<tr bgcolor='#EEF6FF'>
					<td align='center' class='TDCont' width='150'>구분</td>
...
%>
				...
				<table width="100%" height="5" border="0" cellspacing="0" cellpadding="0" align="center"><tr><td></td></tr></table>
					...
					<table width="1200"  border="1" cellpadding="0" cellspacing="0" bgcolor="#EFECE5" align="left" bordercolor="black" bordercolordark="white" bordercolorlight="black">
						<tr height="30">
							<td align="left" bgcolor="#FFFFFF" class="TDCont" colspan="300">&nbsp;<b><font color="#ff00ff"></font> 9. 조치별</b> (전화끊김,침묵(탐색)전화,기타 제외)</b></td>
						</tr>
						...
						do until rs.eof
							...
							if subRs.eof = false then
								...
								if icol > 1 then
									icol = icol + 1
									secondLine = secondLine & "<td bgcolor='#EEF6FF' align='center' class='TDCont'  width='90'>계</td>"
									iColTot = iColTot + 1
			...
			<table width="1200"  border="1" cellpadding="0" cellspacing="0" bgcolor="#EFECE5" align="left" bordercolor="black" bordercolordark="white" bordercolorlight="black">
				<tr height="30">
					<td align="left" bgcolor="#FFFFFF" class="TDCont" colspan="12">&nbsp;&nbsp;<b><font color="#ff00ff"></font> 10. 날씨별</b> </td>
				</tr>
				<tr bgcolor='#EEF6FF'>
					<td align='center' class='TDCont' width='150'>구분</td>
