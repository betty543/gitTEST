...
case "INS"
	...
	case "B"
		...
		INS_SQL = "INSERT INTO TB_ARMYINFO(ACLASS, BCLASS, CCLASS, CLASSNAME, USEYN, INCODE) VALUES "
		INS_SQL = INS_SQL & "('"&Aclass&"','"&s_code&"',null,'"&s_name&"','" &UseYN& "','"&INCODE&"')"
		pageUrl = "ProType_2.asp?Aclass=" & Aclass
		pageFrame = "Pro2fr"
	case "C"
		SQL = "SELECT * FROM TB_ARMYINFO WHERE ACLASS = '" & Aclass & "' AND BCLASS = '" & Bclass & "' AND CCLASS = '" &s_code& "' "
		
		INS_SQL = "INSERT INTO TB_ARMYINFO(ACLASS, BCLASS, CCLASS, CLASSNAME, USEYN, INCODE, COUNSELORYN) VALUES "
		INS_SQL = INS_SQL & "('"&Aclass&"','"&Bclass&"','"&s_code&"','"&s_name&"','" &UseYN& "','"&INCODE&"','"&COUNSELORYN&"')"
	...
	case "D"
		...
		INS_SQL = "INSERT INTO TB_ARMYINFO(ACLASS, BCLASS, CCLASS,DCLASS, CLASSNAME, USEYN, INCODE, COUNSELORYN) VALUES "
		INS_SQL = INS_SQL & "('"&Aclass&"','"&Bclass&"','"&Cclass&"','"&s_code&"','"&s_name&"','" &UseYN& "','"&INCODE&"','"&COUNSELORYN&"')"
...
case "UP"
	...
	flag = "N"			'UPDATE 성공여부
	'제품분류 1차 수정
	SQL = "UPDATE TB_ARMYINFO SET COUNSELORYN = '" &COUNSELORYN& "', UseYN='" &UseYN& "', CLASSNAME='" &s_name& "', MOCODE='" &MOCODE& "', MODATE = getdate()"
