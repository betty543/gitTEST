...
<table width="1200" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr align="center">
        ...
        <td width="300" class="FBlkB" valign="top">
        	<!-- 3차 분류 시작 -->
			<iframe src="ProType_5.asp?Aclass=<%=Aclass%>&Bclass=<%=Bclass%>&Cclass=<%=Cclass%>&Dclass=<%=Dclass%>" frameborder=0 marginheight=0 marginwidth=0 width="100%" scrolling="no" name="Pro5fr"> </iframe>
			<!-- 3차 분류 끝 -->
        </td>
    </tr> 
</table>
