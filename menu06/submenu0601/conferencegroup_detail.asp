		...
		<td colspan="2" height="110">
			<table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#CCCCCC">
				...
				<tr>
					...
					<td width="70%" bgcolor="#ffffff"><input type="radio" name="groupgb" value="1" <%If groupgb = "1" Then response.write "checked" End If %> class="none" disabled> 개인
						<input type="radio" name="groupgb" value="2" <%If groupgb = "2" Then response.write "checked" End If %> class="none" disabled> 공용<input type="radio" name="groupgb" value="3" <%If groupgb = "3" Then response.write "checked" End If %> class="none" > 다자간통화용</td>
				</tr>
				<tr>
